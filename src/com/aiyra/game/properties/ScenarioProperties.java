...
{
    public static final int NUMBER_OF_SCENARIOS = 7;
    ...
    public static final double[] specialFactors =
    {
        0.05,
        0.05,
        0.05,
    ...
    public static final double[] fireFactors =
    {
        0.70,
        0.05,
        0.15,
    ...
    public static final double[] iceFactors =
    {
        0.05,
        0.70,
        0.15,
    ...
    public static final double[] stoneFactors =
    {
        0.15,
        0.15,
        0.60,
    ...
    public static final double[] antimatterFactors =
    {
        0.05,
        0.05,
        0.05,
